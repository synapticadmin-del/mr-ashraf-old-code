...
with_node \
  ...
  --target "/Users/abdullah/Desktop/free/TestingApp/ios/Pods/Target Support Files/Pods-learningapp/ExpoModulesProvider.swift" \
  --entitlement "/Users/abdullah/Desktop/free/TestingApp/ios/learningapp/learningapp.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-av" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-image-picker" "expo-keep-awake" "expo-linking" "expo-print" "expo-router" "expo-screen-capture" "expo-sharing" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
